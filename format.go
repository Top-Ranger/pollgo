...
func FormatTimeDisplay(t time.Time, format string) string {
	...
	switch t.Weekday() {
	case time.Monday:
		weekday = tl.WeekdayMonday
	case time.Tuesday:
		weekday = tl.WeekdayTuesday
	case time.Wednesday:
		weekday = tl.WeekdayWednesday
	case time.Thursday:
		weekday = tl.WeekdayThursday
	case time.Friday:
		weekday = tl.WeekdayFriday
	case time.Saturday:
		weekday = tl.WeekdaySaturday
	case time.Sunday:
